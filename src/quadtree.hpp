...
struct Node
{
    ...
    Node(bool _is_leaf, Boundary _boundary, short int _luminance,
...
struct QuadTree
{
    short int (*IMG)[MAX_IMG_RES][MAX_IMG_RES];
    short int IMG_resolution;
    short int compression_parameter;
    Node* root_node;
    vector<bool> binarized_tree;

    QuadTree(short int (*_IMG)[MAX_IMG_RES][MAX_IMG_RES], int _IMG_resolution, short int _compression_parameter);
